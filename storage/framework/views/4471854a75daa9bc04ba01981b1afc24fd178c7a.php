 ...
 <!-- Font Awesome -->
 <link href="<?php echo e(url('vendors/font-awesome/css/font-awesome.css')); ?>" rel="stylesheet">
 <!-- NProgress -->
 ...
 <link href="<?php echo e(url('build/css/animate.min.css')); ?>" rel="stylesheet">
 <?php /**PATH C:\xampp\htdocs\fungames_asiaa\resources\views/admin/head/head.blade.php ENDPATH**/ ?>